...
void printUsage() {
    std::cout << 
        "TeraMEM computes the (super or locally) maximal exact matches in the text with respect to itself.\n"
        "It requires as input the ms_index generated TeraIndex.\n"
        "\n"
        "Usage: TeraMEM <arguments>\n"
        "Options:\n"
        "  Input:\n"
